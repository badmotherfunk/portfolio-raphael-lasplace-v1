...
mm.add("(min-width: 1950px)", function () {
  var range = 13 / 400;
  var vw = range * Math.min(window.innerWidth, window.innerHeight);
  document.documentElement.style.setProperty('--vw-scale', "".concat(vw));
});
mm.add("(max-width: 1505px)", function () {
  var range = 11 / 400;
  var vw = range * Math.min(window.innerWidth, window.innerHeight);
  document.documentElement.style.setProperty('--vw-scale', "".concat(vw));
});
...
typeWriter.pauseFor(8100).changeDelay(20).typeString('I\'m <span class="media__text"> Raphaël</span>').pauseFor(300).typeString(',  a thirty-years-old French <em><span class="media__text"> front-end </span></em> web developer.').pauseFor(1000).typeString('<br> I like to do stuff with <em><span class="media__text">Css</span></em>.').pauseFor(1000).deleteChars(5).typeString('<em><span class="media__text">Javascript</span></em>.').pauseFor(1000).deleteChars(12).typeString('<em><span class="media__text">React.js !</span></em>').pauseFor(1000).typeString('<br> I\'m passionate about crafting <em><div class="animatedText"; data-text="attractive";><span class="animatedText">beautiful</span></div></em> & <em><div class="animatedText2"; data-text="creative";><span class"animatedText2">designed</span></div></em> websites.').start();
